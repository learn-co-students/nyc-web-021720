...
- the whole thing
- removing the image from the plate 
- taking sushi off the plate onClick 
- displaying 4 instead of all
- alt props (probably on sushi)
- function invocation vs passing a reference 
- prevState (componentDidUpdate) vs altering state... 
